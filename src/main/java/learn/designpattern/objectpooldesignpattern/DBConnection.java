...
public class DBConnection {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        try (Connection connection = new DBConnection("jdbc:sqlite:/Users/karthikp/Library/DBeaverData/workspace6/.metadata/sample-database-sqlite-1/Chinook.db").getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(sql);) {
            preparedStatement.setInt(1, 5);
            try (ResultSet resultSet = preparedStatement.executeQuery();) {
                while (resultSet.next()) {
                    String res = resultSet.getInt("AlbumId") + " " + resultSet.getString("Title");
